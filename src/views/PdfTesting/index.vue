...
<template>
  <div class="pdf-container">
    <h1>Halaman PDFMake Dynamic 📄</h1>
    <p style="color: var(--text-muted)">
      PDF ini di-generate secara real-time menggunakan Javascript.
    </p>

    <div class="button-group">
      <button @click="viewPdf" class="btn btn-view">
        👁️ Generate & Lihat (Tab Baru)
      </button>
    ...
    <router-link to="/" class="back-link">← Kembali ke Chat</router-link>
  </div>
</template>
